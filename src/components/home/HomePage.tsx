  ...
  return (
    <section>
      <div className='h-screen flex justify-center'>
        <section className='flex flex-col items-center text-5xl font-bold text-white max-w-6xl mt-20 leading-relaxed text-center'>
          ...
          <h2>
            To immerse yourself in exciting tests, you must{' '}
            <Link to='login' className='font-medium text-amber-300  hover:underline'>
              login
            </Link>{' '}
            to to your account or{' '}
            <Link to='registration' className='font-medium text-amber-300  hover:underline'>
              register ! ! !
            </Link>
          </h2>
