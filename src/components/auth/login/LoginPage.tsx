      ...
      <div className='bg-white p-8 space-y-6 rounded-md '>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-10'>
          <div className='flex flex-col text-3xl space-y-0.5'>
            ...
            <Input type='email' formNoValidate id='email' variant='default'
                   inputSize='default' {...register('email')} />
            {errors.email &&
          ...
          <div className='flex flex-col text-3xl space-y-0.5'>
            ...
            <div className='flex items-center  relative'>
              <Input id='password' autoComplete='password' variant='default' inputSize='default'
          ...
          <div className='flex justify-between items-center space-x-5'>
            <div className='space-x-2'>
              ...
              <label htmlFor='rememberMe' className='text-2xl'>Remember me</label>
            </div>
          </div>
          <div className='flex items-center space-x-4'>
            ...
            <div className='text-2xl'>
              Don`t have an account? <Link to='registration'
                                           className='font-medium text-amber-500  hover:underline'> Create
              it!</Link>
            </div>
          </div>
        </form>
